...
| Certified ceiling | `>=24.16.0 <25 || >=26.1.0` | 2026.9.3 | Current compatibility ceiling |

Certified support: `2026.7.1-2` through `2026.9.3`. Both endpoints must pass real CLI installation, exact typed-hook inspection, Node-engine validation, local firewall cases, package build and dependency checks before this range is extended.
